...
const Achivement = () => {
  return (
    <div className='min-h-[80vh]'>
      <h1 className='text-4xl pt-8 text-white text-center hover:text-indigo-500 text-3xl font-semibold'>My Achivements</h1>
      ...
      <div className='animate__animated animate__fadeInDown animate__delay-1s'>
          <img src="/achivement/pherolevel.jpg" alt="" />
        </div>


      <div className='animate__animated animate__fadeInUp animate__delay-1s'>
          <img src="/achivement/blackbelt.png" alt="" />
        </div>

       

      <div className='animate__animated animate__fadeInRight animate__delay-1s'>
          <img src="/achivement/achievement.jpg" alt="" />
        </div>
        ...
        <div className='animate__animated animate__fadeInUp animate__delay-1s'>
          <img src="/achivement/iusachieve.png" alt="" />
        </div>
  

        <div className='animate__animated animate__fadeInRight animate__delay-2s'>
          <img src="/achivement/plevel2.png" alt="" />
        </div>
        ...
        <div className='animate__animated animate__fadeInDown animate__delay-1s'>
          <img src="/achivement/hackerrank.png" alt="" />
        </div>
